...
def create_matrix_step(
    ...
    rnd_matrix_output_artifact: Output[Dataset],
    d1: int = 5,
    d2: int = 6,
    booltest: bool = True,
    strtest: str = "test",
...
def sum_matrix_step(
    ...
    rnd_matrix_input_artifact: Input[Dataset],
    d1: int = 5,
    d2: int = 6,
    booltest: bool = True,
    strtest: str = "test",
...
def auto_generated_pipeline(
    ...
    sum_matrix_task = sum_matrix_step(
        rnd_matrix_input_artifact=create_matrix_task.outputs[
            "rnd_matrix_output_artifact"
        ],
        d1=d1,
        d2=d2,
        booltest=booltest,
