...
_kale_datapreprocessing_op = _kfp_components.func_to_container_op(datapreprocessing)


_kale_featureengineering_op = _kfp_components.func_to_container_op(featureengineering)
...
_kale_logisticregression_op = _kfp_components.func_to_container_op(logisticregression)
...
def auto_generated_pipeline():
    ...
    _kale_loaddata_task = _kale_loaddata_op().add_pvolumes(_kale_pvolumes_dict).after()
    ...
    _kale_loaddata_task.add_pod_label("pipelines.kubeflow.org/metadata_written", "true")
    _kale_dep_names = _kale_loaddata_task.dependent_names + _kale_volume_step_names
    ...
    _kale_datapreprocessing_task = (
        _kale_datapreprocessing_op()
    ...
    _kale_output_artifacts.update({"datapreprocessing": "/datapreprocessing.html"})
    _kale_datapreprocessing_task.output_artifact_paths.update(_kale_output_artifacts)
    _kale_datapreprocessing_task.add_pod_label(
        "pipelines.kubeflow.org/metadata_written", "true"
    )
    _kale_dep_names = (
        _kale_datapreprocessing_task.dependent_names + _kale_volume_step_names
    )
    ...
    _kale_output_artifacts.update({"featureengineering": "/featureengineering.html"})
    _kale_featureengineering_task.output_artifact_paths.update(_kale_output_artifacts)
    _kale_featureengineering_task.add_pod_label(
        "pipelines.kubeflow.org/metadata_written", "true"
    )
    _kale_dep_names = (
        _kale_featureengineering_task.dependent_names + _kale_volume_step_names
    )
    ...
    _kale_decisiontree_task.output_artifact_paths.update(_kale_output_artifacts)
    _kale_decisiontree_task.add_pod_label(
        "pipelines.kubeflow.org/metadata_written", "true"
    )
    _kale_dep_names = _kale_decisiontree_task.dependent_names + _kale_volume_step_names
    ...
    _kale_svm_task.add_pod_label("pipelines.kubeflow.org/metadata_written", "true")
    _kale_dep_names = _kale_svm_task.dependent_names + _kale_volume_step_names
    ...
    _kale_dep_names = _kale_naivebayes_task.dependent_names + _kale_volume_step_names
    ...
    _kale_logisticregression_task = (
        _kale_logisticregression_op()
        .add_pvolumes(_kale_pvolumes_dict)
        .after(_kale_featureengineering_task)
    )
    ...
    _kale_output_artifacts.update({"logisticregression": "/logisticregression.html"})
    _kale_logisticregression_task.output_artifact_paths.update(_kale_output_artifacts)
    _kale_logisticregression_task.add_pod_label(
        "pipelines.kubeflow.org/metadata_written", "true"
    )
    _kale_dep_names = (
        _kale_logisticregression_task.dependent_names + _kale_volume_step_names
    )
    ...
    _kale_randomforest_task = (
        _kale_randomforest_op()
        .add_pvolumes(_kale_pvolumes_dict)
        .after(_kale_featureengineering_task)
    )
    ...
    _kale_randomforest_task.output_artifact_paths.update(_kale_output_artifacts)
    _kale_randomforest_task.add_pod_label(
        "pipelines.kubeflow.org/metadata_written", "true"
    )
    _kale_dep_names = _kale_randomforest_task.dependent_names + _kale_volume_step_names
    ...
    _kale_results_task.add_pod_label("pipelines.kubeflow.org/metadata_written", "true")
    _kale_dep_names = _kale_results_task.dependent_names + _kale_volume_step_names
...
if __name__ == "__main__":
    ...
    pipeline_id, version_id = kfputils.upload_pipeline(pipeline_filename, "titanic-ml")
